  ...
  <script src="../js/index.js"></script>
                <div class="col shadow-sm py-1" style="height:50px;overflow:hidden;">
                    <div class="d-flex">
                        <div class="col-8">
                        </div>
                        <div class="col py-2">
                            <a href="#" onclick="myFunction3()" class="dropbtn3 text-dark"><b class="m-1">BRANCH</b></a>
                            <div id="myDropdown3" class="dropdown-content3 shadow ">
                        ...
                        <div class="col py-2">
                            ...
                            <div id="myDropdown0" class="dropdown-content0 shadow ">
